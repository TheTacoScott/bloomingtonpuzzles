...
while nodes_to_process:
  ...
  if person_node_with_fewest_edges and wine_node_with_fewest_edges:
    ...
    wine_sold += 1
    print "{2: >10}\t{0: >10}\t{1: >10}\tBuffer: {3}\tW: {4}\tP:{5}".format(person_node_with_fewest_edges,wine_node_with_fewest_edges,wine_sold,g_person_node_count+g_wine_node_count,g_wine_node_count,g_person_node_count)
